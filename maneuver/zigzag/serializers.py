# maneuver/zigzag/serializers.py
import numpy as np
from rest_framework import serializers


class ZigzagInputSerializer(serializers.Serializer):
    ...
    t0 = serializers.FloatField(default=10.0, required=False)
    ui_initial = serializers.FloatField(default=0.0, required=False)
    ...
    def validate_ui_initial(self, value):
