# maneuver/anderson/serializers.py
import numpy as np
from rest_framework import serializers

class AndersonInputSerializer(serializers.Serializer):
    ...
    Tmax = serializers.FloatField(default=1200.0, required=False)
    h = serializers.FloatField(default=0.1, required=False)
    psi_target_deg = serializers.FloatField(default=100.0, required=False)
    delta_hard_deg = serializers.FloatField(default=35.0, required=False)
    max_rudder_rate_deg = serializers.FloatField(default=5.0, required=False)
