# maneuver/williamsom/serializers.py
import numpy as np
from rest_framework import serializers


class WilliamsonTurnInputSerializer(serializers.Serializer):
    # ── Ship parameters (required) ──
    ...
    delta1 = serializers.FloatField(default=35.0, required=False)
    ...
    # ── Hydrodynamic coefficients (default = 0) ──
