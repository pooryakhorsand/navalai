...
from .engine import TurningModel, _COEF_ORDER
...
def _parse_payload(data):
    ...
    t0 = _as_float(data, "t0", default=100.0)
    ui_deg = _as_float(data, "ui", default=-35.0)
...
class TurningSimulationView(View):
    """
    Optimized turning circle simulation endpoint.

    POST /maneuver/turning/
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            output_payload = {
                ...
                "data": {
                    "metrics": {
                        "transfer_val": _safe_float(transfer_val),
                        "advance_val": _safe_float(advance_val),
                        "tactical_val": _safe_float(tactical_val),
                    },
                    "time_series": time_series_payload,
                    "series_meta": series_meta,
                },
                "message": "Turning Circle simulation completed successfully.",
            }
