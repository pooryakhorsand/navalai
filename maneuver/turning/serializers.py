# maneuver/turning/serializers.py
import numpy as np
from rest_framework import serializers


class TurningInputSerializer(serializers.Serializer):
    ...
    t0 = serializers.FloatField(default=100.0, required=False)
    ui = serializers.FloatField(default=-35.0, required=False)
